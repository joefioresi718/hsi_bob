...
# Clean pop file
clean_file(acs_pop_file, 'clean_data/Cleaned Pop File.csv')

# Clean race file
clean_file(acs_race_file, 'clean_data/Cleaned Race File.csv')

# Clean education file
clean_file(acs_education_file, 'clean_data/Cleaned Education File.csv')

# Clean income file
clean_file(acs_income_file, 'clean_data/Cleaned Income File.csv')

# Clean poverty file
clean_file(acs_pov_file, 'clean_data/Cleaned Poverty File.csv')

# Clean insurance file
clean_file(acs_insurance_file, 'clean_data/Cleaned Insurance File.csv')
